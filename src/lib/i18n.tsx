...
const messages = {
  'zh-CN': {
    nav: { purchase: '购买充值', claude: 'Claude 充值', selfRecharge: '自助充值', help: '帮助中心', partners: '代理合作', support: '支持', recharge: '立即充值', privacy: '隐私保护', terms: '用户协议' },
  ...
  en: {
    nav: { purchase: 'Purchase', claude: 'Claude recharge', selfRecharge: 'Self service', help: 'Help center', partners: 'Partners', support: 'Support', recharge: 'Recharge now', privacy: 'Privacy', terms: 'Terms' }, common: { backHome: 'Back to home', email: 'Email', contact: 'Contact us' },
  ...
  ru: {
    nav: { purchase: 'Пополнить', claude: 'Пополнить Claude', selfRecharge: 'Самообслуживание', help: 'Центр помощи', partners: 'Партнерам', support: 'Поддержка', recharge: 'Пополнить', privacy: 'Конфиденциальность', terms: 'Условия' }, common: { backHome: 'На главную', email: 'Почта', contact: 'Связаться с нами' },
