...
const messages = {
  'zh-CN': {
    nav: { purchase: '购买充值', selfRecharge: '自助充值', help: '帮助中心', partners: '代理合作', support: '支持', recharge: '立即充值', privacy: '隐私保护', terms: '用户协议' },
    common: { backHome: '返回首页', email: '邮箱', contact: '联系我们' },
    home: {
      badge: 'CHATGPT SUBSCRIPTION SERVICE', title: 'ChatGPT 订阅服务', titleAccent: '清晰选择，安心交付',
      intro: '选择适合你的订阅方案，完成支付后按订单指引联系交付。我们不会要求你提供 ChatGPT 账号密码。',
  ...
  ru: {
    nav: { purchase: 'Пополнить', selfRecharge: 'Самообслуживание', help: 'Центр помощи', partners: 'Партнерам', support: 'Поддержка', recharge: 'Пополнить', privacy: 'Конфиденциальность', terms: 'Условия' }, common: { backHome: 'На главную', email: 'Почта', contact: 'Связаться с нами' },
    home: { badge: 'CHATGPT SUBSCRIPTION SERVICE', title: 'Подписка ChatGPT', titleAccent: 'Понятный выбор, внимательное сопровождение', intro: 'Выберите подходящую подписку. После оплаты следуйте инструкциям в заказе. Мы никогда не запрашиваем пароль от ChatGPT.', recharge: 'Пополнить', viewPlans: 'Посмотреть три тарифа', popular: 'Популярный тариф', standardPlan: 'Стандартная подписка', featured: 'Ваш аккаунт · Помощь с подключением · 30 дней поддержки', featuredBenefits: ['Для повседневного общения, творчества и учебы', 'После оплаты следуйте инструкциям заказа', 'По вопросам заказа доступна поддержка по почте'], allPlans: 'Все тарифы', highlights: [['Ваш аккаунт', 'Пароль не требуется'], ['Понятные тарифы', 'Цены и условия наглядны'], ['Поддержка заказа', 'Напишите нам по вопросам заказа'], ['Переход к оплате', 'Оплата на партнерском сайте']], plansEyebrow: 'ТАРИФЫ', plansTitle: 'Выберите тариф подписки', plansText: 'После выбора тарифа вы перейдете на страницу партнера. Приоритет имеют цены на странице оплаты.', recommended: 'Рекомендуем', subscription: 'ТАРИФ ПОДПИСКИ', howEyebrow: 'КАК ЭТО РАБОТАЕТ', howTitle: 'Три шага к подписке', steps: [['Выберите тариф', 'Выберите уровень под свои задачи.'], ['Оплатите заказ', 'Оформите заказ на партнерской странице.'], ['Следуйте инструкциям', 'Завершите подключение по инструкции заказа.']], faqTitle: 'Частые вопросы', faq: [['Когда я смогу пользоваться?', 'После оплаты следуйте инструкции на странице оплаты для связи с поддержкой. Срок зависит от ответа поддержки и статуса аккаунта.'], ['Как проходит подключение?', 'Выберите тариф здесь, оплатите заказ и следуйте инструкции на странице оплаты. Пароль не требуется.'], ['Безопасна ли оплата?', 'Оплата проходит на партнерской странице. Используйте только официальные ссылки этого сайта.'], ['Что делать при проблеме с заказом?', 'Сохраните чек и детали заказа, затем напишите в поддержку.'], ['Можно купить несколько подписок?', 'Да. Выберите количество; доступное количество и финальная цена определяются партнерской страницей.'], ['Нужен ли пароль?', 'Нет. Никогда не передавайте пароль от аккаунта третьим лицам.']], finalTitle: 'Начните с выбора тарифа', finalText: 'На следующей странице представлены все три тарифа.' },
